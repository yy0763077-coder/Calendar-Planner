        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20, padding: '8px 24px 40px 24px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <h2 style={{ fontSize: 24, fontWeight: 700, color: '#171116', letterSpacing: '-0.02em', margin: 0 }}>
                {isEditing ? '编辑行程' : '创建行程'}
              </h2>
              {displayDay && (
                <span style={{ fontSize: 20, color: '#94A3B8', fontWeight: 500 }}>— {displayDay} 日</span>
              )}
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <label style={{ fontSize: 16, fontWeight: 600, color: '#0F172A', opacity: 0.6, letterSpacing: '0.05em', paddingBottom: 8 }}>
                行程内容
              </label>
              <textarea
                ref={textareaRef}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              {isEditing && (
                ...
                >
                  ...
                  <span style={{ fontSize: 20, fontWeight: 700 }}>删除行程</span>
                </button>
              )}
            </div>
          </div>
